...
public class OrdersListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        System.out.println(orders.getId()+"buyer  "+ orders.getUser().getAvatar());
        String avatarUrl = HttpMethods.BASE_URL + orders.getUser().getAvatar();
        Picasso.with(context).load(avatarUrl).resize(30, 30).centerInside().into(avatarImg);

        nameText.setText(orders.getUser().getName());
