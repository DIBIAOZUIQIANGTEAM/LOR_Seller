...
import com.wsns.lor.seller.chatting.utils.ViewHolder;
...
public class ConversationListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convItem.getType().equals(ConversationType.single)) {
            ...
            Picasso.with(mContext).load(HttpMethods.BASE_URL +"upload/user/"+userInfo.getUserName()+".png").placeholder(R.drawable.unknow_avatar).error(R.drawable.unknow_avatar).into(headIcon);
