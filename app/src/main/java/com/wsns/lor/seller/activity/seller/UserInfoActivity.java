    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnLoginOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putBoolean(seller.getAccount() + "auto", false);
                editor.commit();
...
//                JPushInterface.setAlias(UserInfoActivity.this,"",null);
                ...
                public void gotResult(final int i, String s) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (i == 0) {
                                Picasso.with(UserInfoActivity.this).load(HttpMethods.BASE_URL+ seller.getAvatar())
    ...
    void reLoad(){
        ...
        fragmentUsercoins.setTvUserAttribute("金额");
        fragmentUsercoins.setTvUserContent(seller.getCoin() + "");
