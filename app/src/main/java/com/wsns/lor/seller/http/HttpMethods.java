...
public class HttpMethods {
    ...
    public void getRegisterResult(Subscriber<ServerDate<User>> subscriber, String account, String password) {
        ...
        Observable observable = lorService.getRegisterResult(seller)
    ...
    public void getOrdersProgressPage(Subscriber<ServerDate<List<OrdersProgress>>> subscriber,
    ...
    public void getMyOrderPage(Subscriber<ServerDate<List<Orders>>> subscriber,
                               int page) {
    ...
    public void updatePost(Subscriber subscriber,
                             RequestBody avatar) {

        Observable observable = lorService.updatePost(avatar)
                .map(new HttpResultFunc());
    ...
    public void updateSeller(Subscriber<ServerDate<Seller>> subscriber,
                          Seller seller) {

        Observable observable = lorService.updateSeller(latitude,longitude,seller)
                .map(new HttpResultFunc());

        toSubscribe(observable, subscriber);
    }
    public void createSeller(Subscriber<Seller> subscriber, Seller Seller) {

        Observable observable = lorService.createSeller(latitude,longitude,Seller)
                .map(new HttpResultFunc());
    ...
    public void getComments(Subscriber<ResponseBody> subscriber
        ...
        Observable observable = lorService.findCommentsBySeller()
                .map(new HttpResultFunc());

        toSubscribe(observable, subscriber);
    }

    public void reply(Subscriber<ResponseBody> subscriber
            ,String comments,String id) {
        Observable observable = lorService.reply(comments,id)
                .map(new HttpResultFunc());
